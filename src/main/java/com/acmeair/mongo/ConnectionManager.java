    ...
    if (acmeairProps != null) {
      try {
        ...
        if (prop.containsKey("minConnectionsPerHost")) {
          options.minConnectionsPerHost(Integer.parseInt(
                  prop.getProperty("minConnectionsPerHost")));
        }
        ...
        if (prop.containsKey("threadsAllowedToBlockForConnectionMultiplier")) {
          options.threadsAllowedToBlockForConnectionMultiplier(Integer.parseInt(prop
      ...
      if (vcapJsonString != null) {
        ...
        if (mongoServiceArray == null) {
          ...
          if ((username == null) || (password == null)) {
            ...
            credentials.add(MongoCredential.createCredential(username, dbname, 
